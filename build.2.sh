GCC_PREFIX=$1
OUTPUT_DIR=$2
CROSS_CC="${GCC_PREFIX}gcc"
CROSS_OBJCOPY="${GCC_PREFIX}objcopy"
CROSS_STRIP="${GCC_PREFIX}strip"
CROSS_NM="${GCC_PREFIX}nm" 
CROSS_RANLIB="${GCC_PREFIX}nm"
...
./grub-mkimage -O riscv64-efi --config=grub_prefix.cfg -p ./ -o $OUTPUT_DIR/grub.efi -d ./grub-core $MODULES_TO_BUILD
